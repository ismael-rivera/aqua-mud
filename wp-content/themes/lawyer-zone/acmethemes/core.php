...
if ( ! function_exists( 'lawyer_zone_setup' ) ) :
    ...
    function lawyer_zone_setup() {
        ...
        register_nav_menus( array(
            ...
            'ish-custom'    => esc_html__( 'ISH Custom Primary Menu', 'lawyer-zone' )
        ) );
...
function lawyer_zone_scripts() {
	...
	/*Bootstrap*/
    //wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/assets/library/bootstrap/css/bootstrap.css', array(), '3.3.6' );
	//wp_style_add_data( 'bootstrap', 'rtl', 'replace' );

    wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/assets/ish-bootstrap/css/bootstrap.css', array(), '4.2.1' );
    wp_style_add_data( 'bootstrap', 'rtl', 'replace' );
    ...
    //ish-stylesheets and js scripts for overwrites
    wp_enqueue_style( 'ish-styles', get_template_directory_uri() . '/ish-styles.css' );
    wp_enqueue_script( 'ish-scripts', get_template_directory_uri() . '/ish-scripts.js', array(), null, true );
    ...
    /*Bootstrap-OLD use for debugging*/
    wp_enqueue_script('bootstrap', get_template_directory_uri() . '/assets/library/bootstrap/js/bootstrap.min.js', array('jquery'), '3.3.6', 1);

    /*Bootstrap*/
    //wp_enqueue_script('bootstrap', get_template_directory_uri() . '/assets/library/bootstrap/js/bootstrap.min.js', array('jquery'), '4.2.1', 1);
